...
def get_order_details(connection, order_id, product_id):
    cursor = connection.cursor()
    ...
    query = """
        ...
        WHERE order_details.order_id = %s AND order_details.product_id = %s
    """
...
def get_all_orders(connection):
    ...
    response = []
    for (order_id, customer_name, total, date_time, phone_num, status, total) in cursor:
        response.append({
            'order_id': order_id,
